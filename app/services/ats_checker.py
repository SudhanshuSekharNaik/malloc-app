...
def _get_ner_pipeline():
    """
    Lazy-loads yashpwr/resume-ner-bert-v2 token classification pipeline on first use.
    """
...
def _get_role_classifier_pipeline():
    """
    Lazy-loads srivihari/resume-job-role-classifier text classification pipeline on first use.
    """
    pipeline = _safe_import_transformers_pipeline()
